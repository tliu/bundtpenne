...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "bundtpenne", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "bundtpenne";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "bundtpenne", null, { width: 1280, height: 720 });
