...
@:keep @:bind #if display private #end class __ASSET__assets_images_bundt_aseprite extends null { }
...
@:keep @:bind #if display private #end class __ASSET__assets_images_tiles_aseprite extends null { }
